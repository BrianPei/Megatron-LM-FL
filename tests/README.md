...
- [`CI_TESTING_GUIDE.md`](CI_TESTING_GUIDE.md) describes the
  configuration-driven GitHub Actions architecture, platform configuration,
  adding unit/functional/benchmark cases, and CI-equivalent local commands.
- [`UNIT_TEST_GUIDE.md`](UNIT_TEST_GUIDE.md) describes unit-test authoring and
